                    ...
                    {post && (
                        <>
                            <div className="flex">
                                ...
                                {/* 포스트 데이터 */}
                                <div className="w-full pt-2 ml-4">
                                        <div className='flex justify-between '>
                                            <div className='flex-wrap'>
                                                <div className='flex mb-2'>
                                                    <Link
                                                        href={`/u/${post.username}`}
                                                        className=" mr-1 text-xs font-bold cursor-pointer hover:underline"
                                                        >
                                                    @{post.username}
                                                    </Link>
                                                ...
                                                <Link
                                                    ...
                                                    className=""
                                                    >
                                                    <div className='w-fit flex py-[2px] px-1 text-xs font-bold text-gray-400 border-2 border-gray-300  rounded-xl  hover:border-blue-400 hover:text-white hover:bg-blue-400'>
                                                        #{post.subName}
                                                    </div>
                                                </Link>
                                            </div>
                                    ...
                                    {post.body && <p className="mt-2 mb-1 text-sm">{post.body}</p>}
                                    ...
                                    <div className="flex font-semibold text-md mt-3 ">
                                        ...
                                        >
                                            {post.saved ? <LuBookmark className='w-[22px] h-[22px] fill-blue-500 '/> : <LuBookmark className='w-[22px] h-[22px] text-gray-400' />}
                                        </button>
                                    </div>
